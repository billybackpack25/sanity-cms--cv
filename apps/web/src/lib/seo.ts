...
const siteConfig: SiteConfig = {
  title: "Bilal Hasson Full-Stack Developer",
  description: "Bilal Hasson Full-Stack Developer",
  twitterHandle: "@BilalHasso25460",
  keywords: ["bilal", "hasson", "full-stack", "developer", "sanity", "next", "react", "template"],
};
